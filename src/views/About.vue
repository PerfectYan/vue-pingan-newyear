<template>
    <div class="about">
        ...
        <cai-shen :hasCoins="hasCoins" class="about-caishen"></cai-shen>
        <Button class="btn-download" text="即刻生财" @btnClick='download'></Button>
        <Footer :bgGold="bgGold" :iconGold="iconGold"/>
    </div>
</template>
